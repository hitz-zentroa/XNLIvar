...
#SBATCH --job-name=xnli_llama3instruct70
...
#SBATCH --output=/scratch/jbengoetxea/phd/XNLIvar/scripts/generative/logs/xnli_llama3instruct8_%a.log
#SBATCH --error=/scratch/jbengoetxea/phd/XNLIvar/scripts/generative/logs/xnli_llama3instruct8_%a.err
