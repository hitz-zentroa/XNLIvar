...
def main():
    ...
    if training_args.do_predict:
        if model_args.test_data == "eu": 
            ...
            predict_dataset = load_dataset(
                'csv',
                data_files="/tartalo01/users/jbengoetxea004/phd/xnli-paraphrasing/data/eu/xnli.test.eu.native.tsv",
                delimiter="\t",  
                split="train",
                cache_dir=model_args.cache_dir,
                token=model_args.token,
            ...
            predict_dataset = load_dataset(
                'csv',
                data_files="/tartalo01/users/jbengoetxea004/phd/xnli-paraphrasing/data/eu/xnli-native-var-eu-with-locations.tsv",
                delimiter="\t",  
                split="train",
                cache_dir=model_args.cache_dir,
                token=model_args.token,
            ...
            predict_dataset = load_dataset(
                'csv',
                data_files="/tartalo01/users/jbengoetxea004/phd/xnli-paraphrasing/data/en/eu-var-in-english-with-labels.tsv",
                delimiter="\t",  
                split="train",
                cache_dir=model_args.cache_dir,
                token=model_args.token,
